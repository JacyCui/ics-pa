...
enum {
  TYPE_RR, TYPE_I, TYPE_S, TYPE_B, TYPE_U,  TYPE_J,
  TYPE_N, // none
};
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , RR, R(dest) = (sword_t)src1 >> src2);
  INSTPAT("0000000 ????? ????? 010 ????? 01100 11", slt    , RR, R(dest) = (sword_t)src1 < (sword_t)src2);
  INSTPAT("0000000 ????? ????? 011 ????? 01100 11", sltu   , RR, R(dest) = src1 < src2);
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00100 11", srai   , I, R(dest) = (sword_t)src1 >> BITS(imm, 4, 0));
  ...
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , RR, R(dest) = (word_t)BITS((int64_t)SEXT(src1, 32) * (int64_t)SEXT(src2, 32), 31, 0));
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , RR, R(dest) = (word_t)BITS((int64_t)SEXT(src1, 32) * (int64_t)SEXT(src2, 32), 63, 32));
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulsu  , RR, R(dest) = (word_t)BITS((int64_t)SEXT(src1, 32) * (uint64_t)src2, 63, 32));
  INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulu   , RR, R(dest) = (word_t)BITS((uint64_t)src1 * (uint64_t)src2, 63, 32));
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , RR, R(dest) = (sword_t)src1 / (sword_t)src2);
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , RR, R(dest) = src1 / src2);
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , RR, R(dest) = (sword_t)src1 % (sword_t)src2);
